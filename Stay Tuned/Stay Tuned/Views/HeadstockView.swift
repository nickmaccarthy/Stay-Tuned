...
struct HeadstockView: View {
    ...
    var playingToneStringId: Int? = nil  // Which string's tone is playing
    var onDoubleTap: ((GuitarString) -> Void)? = nil  // Double-tap to play tone
    var sizeClass: UserInterfaceSizeClass? = nil  // For adaptive sizing
    ...
    @ViewBuilder
    private func leftTuners(width: CGFloat, height: CGFloat, headstockWidth: CGFloat, headstockTop: CGFloat, headstockHeight: CGFloat) -> some View {
    ...
    @ViewBuilder
    private func rightTuners(width: CGFloat, height: CGFloat, headstockWidth: CGFloat, headstockTop: CGFloat, headstockHeight: CGFloat) -> some View {
